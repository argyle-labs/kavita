...
Manga/ebook/comics server — a first-party [orca](https://github.com/argyle-labs/orca) **service-backend**
...
`deploy`, `backup`, `restore`, `configure`, `status`. Rich, kavita-specific data is
...
The plugin automates kavita, but this repo is self-contained: the docs below (migrated + anonymized from a homelab runbook) let you deploy, configure, and operate it **entirely by hand** on any supported runtime.

- [kavita](docs/kavita.md)
